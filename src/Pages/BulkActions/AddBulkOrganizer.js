...
const AddBulkOrganizer = ({ selectedAccounts, onClose }) => {
    ...
    const handleAccountChange = (event, newValue) => {
        ...
        console.log("Selected Values:", newValue.map((option) => option.value)); // Log just the values
    ...
    const createOrganizerOfAccount = () => {
        ...
        console.log(raw);
        const url = "http://127.0.0.1:7600/workflow/orgaccwise/organizeraccountswise/org";
