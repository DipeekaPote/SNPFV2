    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/" element={<SidebarComponent />}>
          ...
          <Route path="clients/accounts/active" element={<Account />} />
    
          <Route path="clients/contacts" element={<Contact />} />
          <Route path="stages" element={<Stages />} />
          <Route path="addJobs" element={<CreateJob />} />
          <Route path="billing/Invoices" element={<Invoices />} />
          <Route path='billing/proposals' element={<ProposalsELS/>}/>
          ...
          <Route path="/accountsdash/proposals/:data/new" element={<AccountWiseProposal/>}/>
          <Route path="/accountsdash/proposals/:data/update/:_id" element={<AccountWiseProposalUpdate/>}/>
          {/* <Route path="/accountsdash/proposals/:data/new/" element={<AccountWiseProposal/>}/> */}
